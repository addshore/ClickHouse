...
-- Query parameters work in user and role rename targets.
SET param_rename_user_04603 = 'user_rename_04603';
SET param_rename_role_04603 = 'role_rename_04603';
CREATE USER `user_before_04603`;
ALTER USER `user_before_04603` RENAME TO {rename_user_04603:Identifier};
SELECT count() FROM system.users WHERE name = 'user_rename_04603';
DROP USER {rename_user_04603:Identifier};
SELECT count() FROM system.users WHERE name = 'user_rename_04603';
CREATE ROLE `role_before_04603`;
ALTER ROLE `role_before_04603` RENAME TO {rename_role_04603:Identifier};
SELECT count() FROM system.roles WHERE name = 'role_rename_04603';
DROP ROLE {rename_role_04603:Identifier};
SELECT count() FROM system.roles WHERE name = 'role_rename_04603';

SELECT formatQuery('REVOKE SELECT ON *.* FROM ALL, role');
SELECT formatQuery('GRANT SELECT ON *.* TO {g:Identifier}');
SELECT formatQuery('ALTER USER default RENAME TO {rename_user_04603:Identifier}');
SELECT formatQuery('ALTER ROLE default RENAME TO {rename_role_04603:Identifier}');
